...
## 🧠 The 8D Coordinate Space

Every processed token is evaluated against a dual-lens framework across eight distinct dimensions:

### 1. The Post-Enlightenment Materialist Lens (Horizontal)
*   **Utility (U):** Instrumental optimization, extraction, and transactional efficiency.
*   **Fairness (F):** Procedural equity, rights-based access, and systemic safety nets.
*   **Power (P):** Structural asymmetries, institutional control, and hierarchy.
*   **Mimetic (M):** Competitive friction, ideological signaling, and tribal polarization.

### 2. The Universal Essentialist / Dharmic Lens (Vertical)
*   **Telos (T):** Alignment with intrinsic purpose and potential for holistic flourishing.
*   **Structure (S):** Hylomorphic substantial form and ontological integrity.
*   **Dharma (D):** Adherence to cosmic, environmental, and generational balance (*Rta*).
*   **Consciousness (C):** Mindful witness awareness (*Purusha*) vs. mechanical reductionism.
